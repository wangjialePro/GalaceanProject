...
export declare class ControlFreePointer {
    private static _deltaType;
    private static _handlerType;
    private static _frameIndex;
    private static _lastUsefulFrameIndex;
