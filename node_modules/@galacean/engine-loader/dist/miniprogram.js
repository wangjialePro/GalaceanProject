    ...
    _proto.load = function load(item) {
        ...
        if (isBase64(url)) {
            return new miniprogram.AssetPromise(function(resolve) {
                ...
                var result = Uint8Array.from(engineMiniprogramAdapter.atob(base64Str), function(c) {
            ...
            _this.request(item.url, {
                ...
                if (fontUrl) {
                    _this._registerFont(fontName, fontUrl).then(function() {
                        var font = new miniprogram.Font(resourceManager.engine, fontName);
                        resolve(font);
                    }).catch(function(e) {
        ...
        return _async_to_generator(function() {
            ...
            return __generator(this, function(_state) {
                switch(_state.label){
                    ...
                    case 1:
                        _state.sent();
                        engineMiniprogramAdapter.document.fonts.add(fontFace);
                        return [
                            2
                        ];
                }
    ...
    GLTFUtil.floatBufferToColorArray = function floatBufferToColorArray(buffer, isColor3) {
        ...
        if (isColor3) {
            ...
            for(var i1 = 0; i1 < bufferLen; i1 += 4){
                colors[i1 / 4] = new miniprogram$1.Color(buffer[i1], buffer[i1 + 1], buffer[i1 + 2], buffer[i1 + 3]);
            }
        }
        return colors;
    };
...
var AnimationParser = /*#__PURE__*/ function(Parser) {
    ...
    _proto._addCurve = function _addCurve(animationchannelTargetPath, gltfChannel, sampleDataCollection) {
        ...
        switch(animationchannelTargetPath){
            ...
            case AnimationChannelTargetPath.SCALE:
                {
                    ...
                    for(var i = 0, n = input.length; i < n; i++){
                        ...
                        if (interpolation === miniprogram.InterpolationType.CubicSpine) {
                            keyframe.inTangent = new miniprogram$1.Vector3(output[offset++], output[offset++], output[offset++]);
                            keyframe.value = new miniprogram$1.Vector3(output[offset++], output[offset++], output[offset++]);
                            keyframe.outTangent = new miniprogram$1.Vector3(output[offset++], output[offset++], output[offset++]);
                        } else {
                            keyframe.value = new miniprogram$1.Vector3(output[offset++], output[offset++], output[offset++]);
                        }
            ...
            case AnimationChannelTargetPath.ROTATION:
                {
                    var curve1 = new miniprogram.AnimationQuaternionCurve();
                    ...
                    for(var i1 = 0, n1 = input.length; i1 < n1; i1++){
                        ...
                        if (interpolation1 === miniprogram.InterpolationType.CubicSpine) {
                            keyframe1.inTangent = new miniprogram$1.Vector4(output[offset1++], output[offset1++], output[offset1++], output[offset1++]);
                            keyframe1.value = new miniprogram$1.Quaternion(output[offset1++], output[offset1++], output[offset1++], output[offset1++]);
                            keyframe1.outTangent = new miniprogram$1.Vector4(output[offset1++], output[offset1++], output[offset1++], output[offset1++]);
                        } else {
                            keyframe1.value = new miniprogram$1.Quaternion(output[offset1++], output[offset1++], output[offset1++], output[offset1++]);
                        }
            ...
            case AnimationChannelTargetPath.WEIGHTS:
                {
                    var curve2 = new miniprogram.AnimationFloatArrayCurve();
            ...
            Promise.all(item.urls.map(function(url) {
                ...
                for(var face = 0; face < 6; face++){
                    ...
                    for(var miplevel = 0; miplevel < length; miplevel++){
                        ...
                        texture.setPixelBuffer(miniprogram.TextureCubeFace.PositiveX + face, _$data, miplevel, 0, 0, width1, height);
                    }
                }
                resolve(texture);
            }).catch(function(e) {
