        ...
        this._worker.onmessage = function(e) {
            ...
            switch(message.type){
                ...
                case "error":
                    ...
                    break;
                default:
                    engineCore.Logger.error('DRACOWorker: Unexpected message, "' + message.type + '"');
            }
        };
...
var DRACODecoder = /*#__PURE__*/ function() {
    function DRACODecoder(config) {
        ...
        if (config.workerLimit > this.workerLimit) {
            engineCore.Logger.warn("DRACOWorkerPool: Can not initialize worker pool with limit:" + config.workerLimit);
        } else {
    ...
    _proto.preloadLib = function preloadLib() {
        ...
        return new Promise(function(resolve, reject) {
            if (_this.useJS) {
                engineCore.request("" + LIB_PATH + JS_FILE, {
                    type: "text"
                ...
                Promise.all([
                    engineCore.request("" + LIB_PATH + WASM_WRAPPER_FILE, {
                        type: "text"
                    }),
                    engineCore.request("" + LIB_PATH + WASM_FILE, {
                        type: "arraybuffer"
                    })
